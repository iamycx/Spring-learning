...
/**
 * Created by iamycx on 21:16 2017/12/23
 */
@Controller
...
//                eventProducer.fireEvent(new EventModel(EventType.LOGIN).setExt("username",username).setExt("email","956428086@qq.com").setActorId(Integer.parseInt(map.get("userId"))));
